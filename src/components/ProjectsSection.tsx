...
const projects = [
  {
    ...
    githubUrl: "https://github.com/theupsilongirl/neuracare.git",
    featured: true,
  ...
  },
  {
    ...
    githubUrl: "https://github.com/theupsilongirl/E-commerce-website.git",
    featured: true,
  ...
  },
  {
    ...
    githubUrl: "https://github.com/theupsilongirl/converse-pro.git",
    featured: true,
  ...
  },
  {
    ...
    demoUrl: "#",
    githubUrl: "https://github.com/theupsilongirl/Blogni.git",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/theupsilongirl/Spendlix.git",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/theupsilongirl/Eattoo-food-delivery-website.git",
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/theupsilongirl"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
