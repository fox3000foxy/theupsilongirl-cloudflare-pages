...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://linkedin.com/in/emi-tanaka-58b939386", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://instagram.com/emitanaka_official", label: "Instagram" },
    { icon: <Youtube size={18} />, href: "https://youtube.com/@emitanaka_official", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/theupsilongirl", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "emi@emitanaka.fr", href: "mailto:emi@emitanaka.fr.com" },
    { icon: <Phone size={16} />, text: "+33 783846379", href: "tel:+33783846379" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Emi</h3>
          ...
          >
            <div>
              <p>© {currentYear} Emi. All rights reserved.</p>
            </div>
