...
const iconImages: Record<string, string> = {
  ...
  graphql: "/assets/icons/graphql.png",
...
const SkillBar: FC<SkillBarProps> = ({ level }) => (
...
const InfiniteScrollSkills: FC<InfiniteScrollSkillsProps> = ({ skills, iconImages }) => {
  ...
  return (
    <section id="skills" className="py-28 px-4 bg-gradient-to-br from-background via-secondary/5 to-background">
      <div className="container mx-auto max-w-6xl">
        ...
        {activeCategory === "all" ? (
          <InfiniteScrollSkills skills={skills} iconImages={iconImages} />
        ) : (
                ...
                >
                  <div className="flex items-start gap-4 mb-5">
                    <div className="w-12 h-12 rounded-full bg-card border-2 border-primary/50 flex items-center justify-center">
                      <img 
                        src={iconImages[skill.icon] || '/icons/placeholder.png'} 
                        alt={skill.name}
                        className="w-8 h-8 object-contain"
                        loading="lazy"
                      />
