...
import { Briefcase, Calendar, Code, Download, Github, Linkedin, Mail, Sparkles, Star, Target, Twitter, User } from 'lucide-react';
import { useEffect, useState } from 'react';

type TabKey = 'personal' | 'professional' | 'approach';
...
export const AboutSection: React.FC = () => {
  ...
  const socialLinks: SocialLink[] = [
    { icon: <Github className="h-5 w-5" />, href: "https://www.github.com/theupsilongirl" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/emi-tanaka-58b939386/" },
    { icon: <Twitter className="h-5 w-5" />, href: "#" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:emi@emitanaka.fr" }
  ];
  ...
  const handleDownload = () => {
    ...
    link.href = '/Emi-resume.pdf'; // Must be in public folder
    link.download = 'Emi-resume.pdf';
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Emi Tanaka</h2>
